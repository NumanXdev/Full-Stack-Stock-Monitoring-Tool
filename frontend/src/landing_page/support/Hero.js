  ...
  return (
    <section className="" id="supportWrapper">
      <div className="container">
        ...
        <div className="row">
          <div className=" col-12 col-7 p-2 mb-5">
            <h5 style={{ color: "white", fontSize: "25px" }} className="mb-3 d-none d-md-block">
            ...
            >
              <input
                ...
                className="form-control w-75 p-3 w-100"
                style={{ flex: 1 }}
              />
              <i
